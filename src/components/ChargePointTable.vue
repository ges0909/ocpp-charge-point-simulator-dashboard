<template>
  ...
  >
    ...
    <!--
      ...
      -->
    <template v-slot:item.charging_state="{ item }: { item: ChargePoint }">
      <v-row>
        <v-text-field
            disabled
            variant="underlined"
    ...
    <!--
      -- column: meter value
      -->
    <template v-slot:item.meter_value="{ item }: { item: ChargePoint }">
      <v-row>
        <v-text-field
            disabled
            variant="underlined"
